...
class DestinationPage4 extends StatefulWidget {
  const DestinationPage4({Key? key}) : super(key: key);

  @override
  _DestinationPageState createState() => _DestinationPageState();
}

class _DestinationPageState extends State<DestinationPage4> {
      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            ...
            onPressed: () async{
              const url = "https://maps.app.goo.gl/tzN3ayRU9jj1Sxrv5";
